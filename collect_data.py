...
MACRO_PROFILES = {
    ...
    "계란":             {"단백질": 12.0, "탄수화물":  0.7, "지방": 10.0},
    "참치캔":           {"단백질": 21.0, "탄수화물":  0.0, "지방":  4.0},
    "그릭요거트":       {"단백질": 10.0, "탄수화물":  7.0, "지방":  3.0},
    "두부":             {"단백질":  8.0, "탄수화물":  1.0, "지방":  4.0},
    "소고기":           {"단백질": 19.0, "탄수화물":  0.0, "지방": 15.0},
    "돼지고기":         {"단백질": 18.0, "탄수화물":  0.0, "지방": 12.0},
    "냉동새우":         {"단백질": 18.0, "탄수화물":  1.0, "지방":  1.0},
    "고등어":           {"단백질": 18.0, "탄수화물":  0.0, "지방": 12.0},
    "우유":             {"단백질":  3.4, "탄수화물":  4.7, "지방":  3.7},
    "닭가슴살 소시지":  {"단백질": 14.0, "탄수화물":  5.0, "지방":  6.0},
    # 탄수화물
    "고구마":           {"단백질":  2.0, "탄수화물": 20.0, "지방":  0.1},
    "햇반":             {"단백질":  2.4, "탄수화물": 33.0, "지방":  0.5},
    "식빵":             {"단백질":  9.0, "탄수화물": 48.0, "지방":  4.0},
    "바나나":           {"단백질":  1.1, "탄수화물": 22.0, "지방":  0.3},
    "라면":             {"단백질":  9.0, "탄수화물": 55.0, "지방": 14.0},
    "감자":             {"단백질":  2.0, "탄수화물": 17.0, "지방":  0.1},
    "햇반 오곡밥":      {"단백질":  3.0, "탄수화물": 34.0, "지방":  0.5},
    "햇반 현미밥":      {"단백질":  3.0, "탄수화물": 36.0, "지방":  0.6},
    "즉석 쌀국수":      {"단백질":  7.0, "탄수화물": 66.0, "지방":  5.0},
    "옥수수":           {"단백질":  3.2, "탄수화물": 19.0, "지방":  1.2},
    "단팥빵":           {"단백질":  6.0, "탄수화물": 52.0, "지방":  4.0},
    "시리얼":           {"단백질":  7.0, "탄수화물": 84.0, "지방":  1.0},
    # 지방
    "구운 아몬드":      {"단백질": 21.0, "탄수화물": 22.0, "지방": 50.0},
    "피넛버터":         {"단백질": 25.0, "탄수화물": 20.0, "지방": 55.0},
    "견과류 믹스":      {"단백질": 15.0, "탄수화물": 25.0, "지방": 45.0},
    "슬라이스 치즈":    {"단백질": 23.0, "탄수화물":  3.0, "지방": 30.0},
    "올리브오일":       {"단백질":  0.0, "탄수화물":  0.0, "지방": 99.0},
    "버터":             {"단백질":  0.5, "탄수화물":  0.5, "지방": 82.0},
    "아보카도":         {"단백질":  2.0, "탄수화물":  9.0, "지방": 15.0},
    "호두":             {"단백질": 15.0, "탄수화물": 14.0, "지방": 65.0},
    "참기름":           {"단백질":  0.0, "탄수화물":  0.0, "지방":100.0},
    "코코넛오일":       {"단백질":  0.0, "탄수화물":  0.0, "지방":100.0},
}
...
def get_shopping_data():
    ...
    if crawl_ok:
        ...
        df_shop = pd.DataFrame([
            ...
            {"카테고리": "단백질",   "검색어": "단백질 보충제 WPC", "상품명": "WPC 단백질 보충제 1kg",          "가격(원)": 29800, "총중량(g)": 1000, "100g당 가격(원)": 2980.0, "핵심영양소(g)": 800, "핵심영양소 1g당 가격(원/g)":  37.2, "단백질(g/100g)": 80.0, "탄수화물(g/100g)":  5.0, "지방(g/100g)":  5.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "단백질",   "검색어": "계란",              "상품명": "계란 30구",                      "가격(원)":  6900, "총중량(g)": 1500, "100g당 가격(원)":  460.0, "핵심영양소(g)": 180, "핵심영양소 1g당 가격(원/g)":  38.3, "단백질(g/100g)": 12.0, "탄수화물(g/100g)":  0.7, "지방(g/100g)": 10.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "단백질",   "검색어": "참치캔",            "상품명": "동원 참치 150g 5캔",             "가격(원)":  8900, "총중량(g)":  750, "100g당 가격(원)": 1186.7, "핵심영양소(g)": 158, "핵심영양소 1g당 가격(원/g)":  56.3, "단백질(g/100g)": 21.0, "탄수화물(g/100g)":  0.0, "지방(g/100g)":  4.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "단백질",   "검색어": "그릭요거트",        "상품명": "빙그레 그릭요거트 170g 4개",     "가격(원)":  7900, "총중량(g)":  680, "100g당 가격(원)": 1161.8, "핵심영양소(g)":  68, "핵심영양소 1g당 가격(원/g)": 116.2, "단백질(g/100g)": 10.0, "탄수화물(g/100g)":  7.0, "지방(g/100g)":  3.0, "수집시각": collected_at, "수집방식": "백업"},
            ...
            {"카테고리": "단백질",   "검색어": "소고기",            "상품명": "불고기용 소고기 500g",           "가격(원)": 16900, "총중량(g)":  500, "100g당 가격(원)": 3380.0, "핵심영양소(g)":  95, "핵심영양소 1g당 가격(원/g)": 177.9, "단백질(g/100g)": 19.0, "탄수화물(g/100g)":  0.0, "지방(g/100g)": 15.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "단백질",   "검색어": "돼지고기",          "상품명": "돼지고기 목살 500g",             "가격(원)":  6900, "총중량(g)":  500, "100g당 가격(원)": 1380.0, "핵심영양소(g)":  90, "핵심영양소 1g당 가격(원/g)":  76.7, "단백질(g/100g)": 18.0, "탄수화물(g/100g)":  0.0, "지방(g/100g)": 12.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "단백질",   "검색어": "냉동새우",          "상품명": "냉동 칵테일새우 500g",           "가격(원)":  9900, "총중량(g)":  500, "100g당 가격(원)": 1980.0, "핵심영양소(g)":  90, "핵심영양소 1g당 가격(원/g)": 110.0, "단백질(g/100g)": 18.0, "탄수화물(g/100g)":  1.0, "지방(g/100g)":  1.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "단백질",   "검색어": "고등어",            "상품명": "고등어 2마리",                   "가격(원)":  7900, "총중량(g)":  600, "100g당 가격(원)": 1316.7, "핵심영양소(g)": 108, "핵심영양소 1g당 가격(원/g)":  73.1, "단백질(g/100g)": 18.0, "탄수화물(g/100g)":  0.0, "지방(g/100g)": 12.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "단백질",   "검색어": "우유",              "상품명": "서울우유 1L",                    "가격(원)":  2800, "총중량(g)": 1000, "100g당 가격(원)":  280.0, "핵심영양소(g)":  34, "핵심영양소 1g당 가격(원/g)":  82.4, "단백질(g/100g)":  3.4, "탄수화물(g/100g)":  4.7, "지방(g/100g)":  3.7, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "단백질",   "검색어": "닭가슴살 소시지",   "상품명": "닭가슴살 소시지 100g 5개",       "가격(원)":  5900, "총중량(g)":  500, "100g당 가격(원)": 1180.0, "핵심영양소(g)":  70, "핵심영양소 1g당 가격(원/g)":  84.3, "단백질(g/100g)": 14.0, "탄수화물(g/100g)":  5.0, "지방(g/100g)":  6.0, "수집시각": collected_at, "수집방식": "백업"},
            # ── 탄수화물 ────────────────────────────────────────────────
            ...
            {"카테고리": "탄수화물", "검색어": "햇반",              "상품명": "CJ 햇반 210g 6개입",             "가격(원)":  8400, "총중량(g)": 1260, "100g당 가격(원)":  666.7, "핵심영양소(g)": 416, "핵심영양소 1g당 가격(원/g)":  20.2, "단백질(g/100g)":  2.4, "탄수화물(g/100g)": 33.0, "지방(g/100g)":  0.5, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "탄수화물", "검색어": "식빵",              "상품명": "삼립 식빵 480g",                 "가격(원)":  2800, "총중량(g)":  480, "100g당 가격(원)":  583.3, "핵심영양소(g)": 230, "핵심영양소 1g당 가격(원/g)":  12.2, "단백질(g/100g)":  9.0, "탄수화물(g/100g)": 48.0, "지방(g/100g)":  4.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "탄수화물", "검색어": "바나나",            "상품명": "바나나 1kg",                     "가격(원)":  4900, "총중량(g)": 1000, "100g당 가격(원)":  490.0, "핵심영양소(g)": 220, "핵심영양소 1g당 가격(원/g)":  22.3, "단백질(g/100g)":  1.1, "탄수화물(g/100g)": 22.0, "지방(g/100g)":  0.3, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "탄수화물", "검색어": "라면",              "상품명": "신라면 120g 5개입",              "가격(원)":  3800, "총중량(g)":  600, "100g당 가격(원)":  633.3, "핵심영양소(g)": 330, "핵심영양소 1g당 가격(원/g)":  11.5, "단백질(g/100g)":  9.0, "탄수화물(g/100g)": 55.0, "지방(g/100g)": 14.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "탄수화물", "검색어": "감자",              "상품명": "감자 1kg",                       "가격(원)":  3900, "총중량(g)": 1000, "100g당 가격(원)":  390.0, "핵심영양소(g)": 170, "핵심영양소 1g당 가격(원/g)":  22.9, "단백질(g/100g)":  2.0, "탄수화물(g/100g)": 17.0, "지방(g/100g)":  0.1, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "탄수화물", "검색어": "햇반 오곡밥",        "상품명": "CJ 햇반 오곡밥 210g 6개입",       "가격(원)":  9600, "총중량(g)": 1260, "100g당 가격(원)":  761.9, "핵심영양소(g)": 428, "핵심영양소 1g당 가격(원/g)":  22.4, "단백질(g/100g)":  3.0, "탄수화물(g/100g)": 34.0, "지방(g/100g)":  0.5, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "탄수화물", "검색어": "햇반 현미밥",        "상품명": "CJ 햇반 현미밥 210g 6개입",       "가격(원)":  9600, "총중량(g)": 1260, "100g당 가격(원)":  761.9, "핵심영양소(g)": 454, "핵심영양소 1g당 가격(원/g)":  21.1, "단백질(g/100g)":  3.0, "탄수화물(g/100g)": 36.0, "지방(g/100g)":  0.6, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "탄수화물", "검색어": "즉석 쌀국수",        "상품명": "오뚜기 쌀국수 큰컵 92g 6개",      "가격(원)":  8900, "총중량(g)":  552, "100g당 가격(원)": 1613.0, "핵심영양소(g)": 364, "핵심영양소 1g당 가격(원/g)":  24.5, "단백질(g/100g)":  7.0, "탄수화물(g/100g)": 66.0, "지방(g/100g)":  5.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "탄수화물", "검색어": "옥수수",            "상품명": "옥수수 3개",                     "가격(원)":  4500, "총중량(g)":  600, "100g당 가격(원)":  750.0, "핵심영양소(g)": 114, "핵심영양소 1g당 가격(원/g)":  39.5, "단백질(g/100g)":  3.2, "탄수화물(g/100g)": 19.0, "지방(g/100g)":  1.2, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "탄수화물", "검색어": "단팥빵",            "상품명": "단팥빵 5개",                     "가격(원)":  4000, "총중량(g)":  400, "100g당 가격(원)": 1000.0, "핵심영양소(g)": 208, "핵심영양소 1g당 가격(원/g)":  19.2, "단백질(g/100g)":  6.0, "탄수화물(g/100g)": 52.0, "지방(g/100g)":  4.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "탄수화물", "검색어": "시리얼",            "상품명": "켈로그 콘플레이크 500g",         "가격(원)":  5500, "총중량(g)":  500, "100g당 가격(원)": 1100.0, "핵심영양소(g)": 420, "핵심영양소 1g당 가격(원/g)":  13.1, "단백질(g/100g)":  7.0, "탄수화물(g/100g)": 84.0, "지방(g/100g)":  1.0, "수집시각": collected_at, "수집방식": "백업"},
            # ── 지방 ────────────────────────────────────────────────────
            ...
            {"카테고리": "지방",     "검색어": "견과류 믹스",       "상품명": "하루견과 25g 30봉",              "가격(원)": 15900, "총중량(g)":  750, "100g당 가격(원)": 2120.0, "핵심영양소(g)": 338, "핵심영양소 1g당 가격(원/g)":  47.0, "단백질(g/100g)": 15.0, "탄수화물(g/100g)": 25.0, "지방(g/100g)": 45.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "지방",     "검색어": "슬라이스 치즈",     "상품명": "서울우유 체다슬라이스 200g",     "가격(원)":  5500, "총중량(g)":  200, "100g당 가격(원)": 2750.0, "핵심영양소(g)":  60, "핵심영양소 1g당 가격(원/g)":  91.7, "단백질(g/100g)": 23.0, "탄수화물(g/100g)":  3.0, "지방(g/100g)": 30.0, "수집시각": collected_at, "수집방식": "백업"},
            ...
            {"카테고리": "지방",     "검색어": "버터",              "상품명": "서울우유 버터 200g",             "가격(원)":  7500, "총중량(g)":  200, "100g당 가격(원)": 3750.0, "핵심영양소(g)": 164, "핵심영양소 1g당 가격(원/g)":  45.7, "단백질(g/100g)":  0.5, "탄수화물(g/100g)":  0.5, "지방(g/100g)": 82.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "지방",     "검색어": "아보카도",          "상품명": "아보카도 2개",                   "가격(원)":  5900, "총중량(g)":  400, "100g당 가격(원)": 1475.0, "핵심영양소(g)":  60, "핵심영양소 1g당 가격(원/g)":  98.3, "단백질(g/100g)":  2.0, "탄수화물(g/100g)":  9.0, "지방(g/100g)": 15.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "지방",     "검색어": "호두",              "상품명": "호두 500g",                      "가격(원)": 14900, "총중량(g)":  500, "100g당 가격(원)": 2980.0, "핵심영양소(g)": 325, "핵심영양소 1g당 가격(원/g)":  45.8, "단백질(g/100g)": 15.0, "탄수화물(g/100g)": 14.0, "지방(g/100g)": 65.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "지방",     "검색어": "참기름",            "상품명": "참기름 500ml",                   "가격(원)": 12900, "총중량(g)":  500, "100g당 가격(원)": 2580.0, "핵심영양소(g)": 500, "핵심영양소 1g당 가격(원/g)":  25.8, "단백질(g/100g)":  0.0, "탄수화물(g/100g)":  0.0, "지방(g/100g)":100.0, "수집시각": collected_at, "수집방식": "백업"},
            {"카테고리": "지방",     "검색어": "코코넛오일",        "상품명": "코코넛오일 500ml",               "가격(원)": 12900, "총중량(g)":  500, "100g당 가격(원)": 2580.0, "핵심영양소(g)": 500, "핵심영양소 1g당 가격(원/g)":  25.8, "단백질(g/100g)":  0.0, "탄수화물(g/100g)":  0.0, "지방(g/100g)":100.0, "수집시각": collected_at, "수집방식": "백업"},
        ])
